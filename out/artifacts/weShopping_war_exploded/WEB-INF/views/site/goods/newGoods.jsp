        ...
        <ul class="message-l">
            <div class="topMessage">
                <div class="menu-hd">
                    ...
                    <a href="#" target="_top"><i class="am-icon-unlock-alt am-icon-fw"></i>我是管理员</a>
                </div>
            </div>
        </ul>
        <ul class="message-r">
            <div class="topMessage home">
                <div class="menu-hd"><a href="#" target="_top" class="h">平台首页</a></div>
            </div>
    ...
    <div id="f1">
        ...
        <div class="am-g am-g-fixed floodFour">
            <div class="am-u-sm-5 am-u-md-4 text-one list ">
                <div class="word">
                    <c:forEach items="${leibieList.leibieXiashus}" varStatus="stu" var="xiashus">
                        <a class="outer" href="#"><span class="inner"><b class="text">${xiashus.name}</b></span></a>
                    </c:forEach>
                </div>
                <a href="# ">
                    <div class="outer-con ">
             ...
             <c:forEach items="${goodslist}" var="goods" varStatus="stu">
                 <c:if test="${goods.leibieId==leibieList.id}">
                     <div class="am-u-sm-7 am-u-md-4 text-two sug">
                         ...
                         <a href="# "><img src="<%=path%>${goods.fujian}" /></a>
                     </div>
                 </c:if>
             </c:forEach>
        </c:forEach>
