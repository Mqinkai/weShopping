           ...
           <c:if test="${huiyuan.tel !=null and huiyuan.tel != ''}">
               <div class="am-form-group bind">
                   ...
                   <div class="am-form-content">
                       <span id="user-phone">${huiyuan.tel}<a href="javascript:void(0);"  onclick="change()" style="font-size: 2px;color:#b6b6b6">&nbsp;&nbsp;无法接收验证码</a></span>
                   </div>
               </div>
               <div class="am-form-group code">
                ...
                <div class="am-form-group code">
                    ...
                    <div class="am-form-content">
                        <input type="tel" id="user-new-code" readonly="readonly" placeholder="短信验证码">
...
<script type="text/javascript">
    ...
    function sendNewMobileCode() {
        if (oldCode == '' && flag !=''){
            $("").dailog({
                ...
                animateStyle: 'none',
                bottons: ['确定'],
                discription: '请先输入旧手机验证码'
            });
            return false;
        }
        var newPhone = $("#user-new-phone").val();
        if (!isTel.test(newPhone)){
            $("").dailog({
                type: 'danger',
                showBoxShadow: true,
                animateStyle: 'none',
    ...
    function save() {
        ...
        if (tel != ''){
            ...
            console.log(tel);
            $.ajax({
                url:"${ctx}/safety/savePhone?id="+id+"&tel="+tel,
                method: 'get',
