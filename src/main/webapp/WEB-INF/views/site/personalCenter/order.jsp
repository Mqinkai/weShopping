                                    ...
                                    <c:forEach items="${orderList}" var="order" varStatus="status">
                                        <div class="order-status5">
                                            <div class="order-title">
                                                <div class="dd-num">订单编号：<a href="javascript:;">${order.bianhao}</a></div>
                                                <span>成交时间：${order.xiadanshi}</span>
                                            </div>
                                            <div class="order-content">
                                                <div class="order-left">
                                                    <c:forEach items="${order.goodsList}" var="orderDetail" varStatus="stu">
                                                        <ul class="item-list">
                                                            <li class="td td-item">
                                                                <div class="item-pic">
                                                                    <a href="#" class="J_MakePoint">
                                                                        <img src="${orderDetail.fujian}" class="itempic J_ItemImg">
                                                                    </a>
                                                                </div>
                                                                <div class="item-info">
                                                                    <div class="item-basic-info">
                                                                        <a href="#">
                                                                            <p>${orderDetail.mingcheng}</p>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </li>
